...
class JobparserPipeline:
    ...
    def process_item(self, item, spider):
        my_item = dict(item)
        if spider.name == 'hhru':
            item['salary_min'], item['salary_max'], item['salary_cur'] = self.process_hh_salary(item['salary'])
        elif spider.name == 'superjob':
            item['salary_min'], item['salary_max'], item['salary_cur'] = self.process_sj_salary(item['salary'])
